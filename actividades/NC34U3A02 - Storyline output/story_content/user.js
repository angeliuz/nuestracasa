...
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D04", "texto3", 1);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D04", "texto4", 2);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D04", "texto5", 3);
...
console.log(texto3,texto4,texto5);
}
