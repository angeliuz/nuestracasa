...
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D03", "multi7", 7);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D03", "multi8", 8);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D03", "multi9", 9);

window.getRespuestaMultiple(cod_actividad, cod_actividad+"D04", "multi10", 1);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D04", "multi11", 2);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D04", "multi12", 3);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D04", "multi13", 4);
...
console.log(multi1,multi2,multi3,multi4,multi5,multi6,multi7,multi8,multi9);
}
...
var respuesta = [multi1,multi2,multi3,multi4,multi5,multi6,multi7,multi8,multi9];
...
console.log(multi10,multi11,multi12,multi13);
}
...
var respuesta = [multi10,multi11,multi12,multi13];
