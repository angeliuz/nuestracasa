...
function Script2() {
  ...
  console.log("Get Respuesta", window.getRespuesta(cod_actividad, cod_actividad + "D01"))
  ...
  console.log("Get Respuesta", window.getRespuestaMultiple(cod_actividad, cod_actividad + "D01", 3));
}
