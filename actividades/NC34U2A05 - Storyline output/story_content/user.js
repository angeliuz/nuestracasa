...
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D10", "texto4", 1);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D10", "texto5", 2);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D10", "texto6", 3);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D10", "texto7", 4);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D10", "texto8", 5);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D10", "texto9", 6);
...
console.log(texto4,texto5,texto6,texto7,texto8,texto9);
}
...
var arrDiapos = ["D01","D02","D03","D04","D05","D06","D07"];
