...
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D05", "multi7", 1);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D05", "multi8", 2);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D05", "multi9", 3);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D05", "multi10", 4);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D05", "multi11", 5);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D05", "multi12", 6);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D05", "multi13", 7);
...
console.log(multi7,multi8,multi9,multi10,multi11,multi12,multi13);
}
...
var respuesta = [multi7,multi8,multi9,multi10,multi11,multi12,multi13];
