...
console.log("Inicializa actividades en BD",cod_actividad+"D09");
}
...
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D07", "texto6", 1);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D07", "texto7", 2);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D07", "texto8", 3);

window.getRespuestaMultiple(cod_actividad, cod_actividad+"D08", "texto9", 1);

window.getRespuestaMultiple(cod_actividad, cod_actividad+"D10", "drag1", 1);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D10", "drag2", 2);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D10", "drag3", 3);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D10", "drag4", 4);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D10", "drag5", 5);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D10", "drag6", 6);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D10", "drag7", 7);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D10", "drag8", 8);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D10", "drag9", 9);
...
console.log(drag1,drag2,drag3,drag4,drag5,drag6,drag7,drag8,drag9);
}
...
var respuesta = [drag1,drag2,drag3,drag4,drag5,drag6,drag7,drag8,drag9];
