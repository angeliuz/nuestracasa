...
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D01", "multi7", 7);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D01", "multi8", 8);
...
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D05", "drag1", 1);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D05", "drag2", 2);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D05", "drag3", 3);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D05", "drag4", 4);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D05", "drag4", 5);
...
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D07", "texto5", 1);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D07", "texto6", 2);
window.getRespuestaMultiple(cod_actividad, cod_actividad+"D07", "texto7", 3);
...
console.log(multi9,multi10,multi11.multi12);
}
...
var respuesta = [multi9,multi10,multi11,multi12];
